...
Cette documentation fournit une vue d'ensemble complète du système ETL pour TPE/PME. Elle peut être enrichie par des diagrammes et extraits de code pour faciliter la compréhension et la maintenance
